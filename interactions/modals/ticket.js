const { EmbedBuilder, ActionRowBuilder, ButtonBuilder, ChannelType, ButtonStyle, PermissionFlagsBits } = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction, client, color) {
        ...
        createTicket(ticketConfigDatabase, interaction, topic);
