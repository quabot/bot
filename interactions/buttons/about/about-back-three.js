        ...
        interaction.update({
            embeds: [
                new EmbedBuilder()
                    ...
                    .setDescription(`In order to make it easier for the end-user to use QuaBot, we created an online dashboard. With our dashboard you can configure every setting to your liking.
