...
module.exports = {
  ...
  async execute(client, data) {
    ...
    await member.send({
      embeds: [
        new Embed('#416683')
          .setDescription(`Your application response for the form **${FoundForm.name}** has been approved! Some roles may have been added/removed. You can view your answers [here](https://quabot.net/dashboard/${guild.id}/user/applications/answers/${data.responseId}).`)
      ]
    }).catch(() => { });
  }
}