...
module.exports = {
    ...
    async execute(client, interaction, color) {
        ...
        interaction.channel.permissionOverwrites.edit(user, { ViewChannel: false, SendMessages: false }).catch(e => {});

        interaction
            .editReply({
                embeds: [new EmbedBuilder().setColor(color).setDescription(`Removed ${user} from the ticket.`)],
            })
            .catch(e => {});
    },
};
