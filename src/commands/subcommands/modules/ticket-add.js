...
module.exports = {
    ...
    async execute(client, interaction, color) {
        ...
        interaction.channel.permissionOverwrites.edit(user, { ViewChannel: true, SendMessages: true }).catch(e => {});

        interaction
            .editReply({
                embeds: [new EmbedBuilder().setColor(color).setDescription(`Added ${user} to the ticket.`)],
            })
            .catch(e => {});
    },
};
