...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("type")
    .setDescription("Play a typing game.")
    ...
    await interaction.deferReply();
    {
      ...
      collector.on("collect", async (m) => {
        ...
        if (m.content === sentence) {
          //* Get the time and update the message.
      ...
      collector.on("end", (collected) => {
        if (collected.size === 0)
          return interaction.editReply({
            embeds: [
              new Embed(color).setDescription("Failed to respond in time."),
            ],
          });
      });
    }
