...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(command => command.setName("create").setDescription("Create a ticket.")
        ...
        .addSubcommand(command => command.setName("add").setDescription("Add a user to a ticket.")
            .addUserOption(option => option.setName("user").setRequired(true).setDescription("The user to add.")))
        .addSubcommand(command => command.setName("remove").setDescription("Remove a user from a ticket.")
