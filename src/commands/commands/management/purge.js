...
module.exports = {
    ...
    async execute(client, interaction, color) {
        ...
        if (amount > 0) {
            if (amount > 100) return interaction.reply({ content: `You can't delete more than 100 messages.`, ephemeral: true }).catch(() => null);
            ...
            if (public === false) {
                ...
                return interaction.reply({ content: `Deleted ${amount} messages.`, ephemeral: true }).catch(() => null);
            }
        } else {
            return interaction.reply({ content: `You can't delete less than 1 message.`, ephemeral: true }).catch(() => null);
        }
