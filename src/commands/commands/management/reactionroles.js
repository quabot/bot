    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addChannelOption(option =>
                    option.setDescription('Channel where the message is located.').setRequired(true).setName('channel')
                )
                .addStringOption(option =>
                    option.setDescription('The id of the message.').setRequired(true).setName('message')
                )
                .addRoleOption(option => option.setDescription('The role to use.').setRequired(true).setName('role'))
                .addStringOption(option =>
                    option.setDescription('The emoji to react with.').setRequired(true).setName('emoji')
                )
                .addStringOption(option =>
                    option
                ...
                .addStringOption(option =>
                    option
                        .setDescription('The permission required to use this reactionrole.')
                        .setRequired(false)
                        .setName('permission')
                        .addChoices(
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(option =>
                    option
                        .setDescription('The message to remove the reactionrole of.')
                        .setRequired(true)
                        .setName('message_id')
                )
                .addStringOption(option =>
                    option.setDescription('The emoji to remove.').setRequired(true).setName('emoji')
                )
                .addChannelOption(option =>
                    option
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .addStringOption(option =>
                    option
                        .setDescription('The message to list the reactionroles for.')
                        .setRequired(false)
                        .setName('message_id')
                )
                .addRoleOption(option =>
                    option.setDescription('The role to list the reactionroles for.').setRequired(false).setName('role')
                )
                .addChannelOption(option =>
                    option
                        .setDescription('The channel to list the reactionroles for.')
                        .setRequired(false)
                        .setName('channel')
                )
        ),
