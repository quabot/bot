...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addBooleanOption(option =>
            option
                .setName('private')
                .setDescription('Do you want the untimeout to be only visible to you?.')
                .setRequired(false)
        )
                    ...
                    .editReply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    `QuaBot does not have permission to remove a timeout from that user - try moving the QuaBot role above all others`
                                )
                                .setColor(color),
                        ],
                        ephemeral,
            ...
            member
                .send({
                    embeds: [
                        await generateEmbed(
                            color,
                            `Your timeout was removed on **${interaction.guild.name}**
