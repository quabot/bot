...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('reason').setDescription('Reason for warning this user.').setRequired(true)
        )
    ...
    async execute(client, interaction, color) {
        ...
        if (!user || !reason)
            return interaction
                .editReply({
                    embeds: [
                        await generateEmbed(color, 'Please enter both a user and the reason for warning this user.'),
                    ],
                })
                .catch(e => {});
            ...
            member
                .send({
                    embeds: [
                        await generateEmbed(
                            color,
                            `You were warned on **${interaction.guild.name}**
