...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('duration').setDescription('How long to tempban. (1h, 30min, 1w)').setRequired(true)
        )
            ...
            return interaction
                .editReply({
                    embeds: [
                        await generateEmbed(
                            color,
                            'Please enter both a user, duration and the reason for banning this user.'
                        ),
                    ],
                })
                .catch(e => {});
            ...
            member
                .send({
                    embeds: [
                        await generateEmbed(
                            color,
                            `You were tempbanned from **${interaction.guild.name}**
                ...
                embeds: [
                    new EmbedBuilder()
                        ...
                        .addFields(
                            ...
                            {
                                name: 'Unbanned In',
                                value: `<t:${(new Date().getTime() + ms(duration)) / 1000}:R>`,
                                inline: true,
                            }
                        ),
                ],
