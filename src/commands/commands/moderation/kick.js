    ...
    async execute(client, interaction, color) {
        ...
        if (!user || !reason) {
            ...
            return interaction
                .editReply({
                    embeds: [
                        await generateEmbed(color, 'Please enter both a user and the reason for kicking this user.'),
                    ],
                })
                .catch(e => {});
        }
                    ...
                    .editReply({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    `QuaBot does not have permission to kick that user - try moving the QuaBot role above all others`
                                )
                                .setColor(color),
                        ],
                        ephemeral,
