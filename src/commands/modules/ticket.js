...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("unclaim")
        .setDescription("Unclaim a ticket so someone else can claim it."),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("info")
        .setDescription("Receive some information about a ticket."),
    )
    .addSubcommand((subcommand) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName("reopen").setDescription("Reopen a ticket."),
    )
    .addSubcommand((subcommand) =>
      ...
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("new-topic")
            .setRequired(true)
            .setDescription("The new ticket topic."),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
      ...
      subcommand
        ...
        .addUserOption((option) =>
          option
            .setName("user")
            .setRequired(true)
            .setDescription("The user to make the ticket owner."),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("help")
        .setDescription("Show some general information about tickets."),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("remove")
