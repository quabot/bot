  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addBooleanOption((option) =>
          option
            .setDescription(
              "Should the role be separated in the sidebar? (Defaults to false)",
            )
            .setRequired(false)
            .setName("hoist"),
        )
        .addBooleanOption((option) =>
          option
            .setDescription(
              "Should the role be mentionable by everyone? (Defaults to false)",
            )
            .setRequired(false)
            .setName("mentionable"),
        ),
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addBooleanOption((option) =>
          option
            .setDescription("Should the role be separated in the sidebar?")
            .setRequired(false)
            .setName("hoist"),
        ),
    ),
