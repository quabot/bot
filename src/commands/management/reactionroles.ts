  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(command =>
      command
        ...
        .addRoleOption(option =>
          option.setName('role').setDescription('The role to use for the reaction role.').setRequired(true),
        )
        .addStringOption(option =>
          option.setName('emoji').setDescription('The emoji to use for the reaction role.').setRequired(true),
        )
        .addStringOption(option =>
          option
            .setName('mode')
            ...
            .addChoices(
              {
                ...
                value: `${PermissionFlagsBits.CreateInstantInvite}`,
              },
              {
                name: 'Kick Members',
                value: `${PermissionFlagsBits.KickMembers}`,
              },
              {
                name: 'Ban Members',
                value: `${PermissionFlagsBits.BanMembers}`,
              },
              {
                name: 'Timeout Members',
                value: `${PermissionFlagsBits.ModerateMembers}`,
              },
              {
                name: 'Administrator',
              ...
              },
              {
                ...
                value: `${PermissionFlagsBits.ManageChannels}`,
              },
              {
                name: 'Manage Server',
                value: `${PermissionFlagsBits.ManageGuild}`,
              },
              {
                name: 'Add Reactions',
                value: `${PermissionFlagsBits.AddReactions}`,
              },
              {
                name: 'View Channel',
                value: `${PermissionFlagsBits.ViewChannel}`,
              },
              {
                name: 'Send Messages',
                value: `${PermissionFlagsBits.SendMessages}`,
              },
              {
                name: 'Manage Messages',
                value: `${PermissionFlagsBits.ManageMessages}`,
              },
              {
                name: 'Attach Files',
                value: `${PermissionFlagsBits.AttachFiles}`,
              },
              {
                name: 'Read Message History',
                value: `${PermissionFlagsBits.ReadMessageHistory}`,
              },
              {
                name: 'Mention Everyone',
                value: `${PermissionFlagsBits.MentionEveryone}`,
              },
              {
                name: 'Use External Emojis',
                value: `${PermissionFlagsBits.UseExternalEmojis}`,
              },
              { name: 'Connect', value: `${PermissionFlagsBits.Connect}` },
              { name: 'Speak', value: `${PermissionFlagsBits.Speak}` },
              {
                name: 'Mute Members',
                value: `${PermissionFlagsBits.MuteMembers}`,
              },
              {
                name: 'Deafen Members',
                value: `${PermissionFlagsBits.DeafenMembers}`,
              },
              {
                name: 'Move Members',
                value: `${PermissionFlagsBits.MoveMembers}`,
              },
              {
                name: 'Change Nickname',
                value: `${PermissionFlagsBits.ChangeNickname}`,
              },
              {
                name: 'Manage Nicknames',
                value: `${PermissionFlagsBits.ManageNicknames}`,
              },
              {
                name: 'Manage Roles',
                value: `${PermissionFlagsBits.ManageRoles}`,
              },
              {
              ...
              {
                name: 'Manage Threads',
                value: `${PermissionFlagsBits.ManageThreads}`,
              },
            ),
        ),
    )
    ...
    .addSubcommand(subcommand =>
      subcommand
        ...
        .addStringOption(option =>
          option.setDescription('The message to remove the reaction role of.').setRequired(true).setName('message-id'),
        )
    ...
    .addSubcommand(subcommand =>
      subcommand.setName('help').setDescription('View information about the reactionroles module.'),
    )
