  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setDescription("The channel topic.")
            .setRequired(false)
            .setName("topic"),
        )
        .addBooleanOption((option) =>
          option
            .setDescription("Should the channel be marked as NSFW?")
            .setRequired(false)
            .setName("nsfw"),
        ),
    )
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setDescription(
              "The slowmode to set it to (format: 1h, 20min, 30s).",
            )
            .setRequired(true)
            .setName("slowmode"),
        ),
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setDescription("The new channel topic.")
            .setRequired(false)
            .setName("topic"),
        ),
    ),
