...
module.exports = {
	...
	async execute(client, interaction, color) {
		...
		if (ticket.staff !== interaction.user.id) return await interaction.editReply({
			embeds: [
				new Embed(color)
					.setDescription('The ticket isn\'t claimed by you.')
			]
		});
		...
		await interaction.editReply({
			embeds: [
				new Embed(color)
					.setDescription('You have successfully unclaimed the ticket.')
			]
		});
