...
module.exports = {
    data: new ContextMenuCommandBuilder()
        ...
        .setDefaultMemberPermissions(
            PermissionFlagsBits.Administrator | PermissionFlagsBits.BanMembers | PermissionFlagsBits.ModerateMembers
        )
                ...
                return modalInteraction
                    .editReply({
                        embeds: [
                            await generateEmbed(
                                color,
                                'Please enter both a user and the reason for timing out this user.'
                            ),
                        ],
                    })
                    .catch(e => {});
            ...
            member
                .send({
                    embeds: [
                        await generateEmbed(
                            color,
                            `You were timed out on **${modalInteraction.guild.name}**
