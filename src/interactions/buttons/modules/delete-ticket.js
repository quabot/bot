...
module.exports = {
    ...
    async execute(client, interaction, color) {
        ...
        const msg = await interaction
            .editReply({
                embeds: [
                    new EmbedBuilder().setColor(color).setDescription('Are you sure you want to delete this ticket?'),
                ],
                components: [
        ...
        if (!msg) return;
        const collectorRepeat = msg.createMessageComponentCollector({
        ...
        collectorRepeat.on('collect', async interaction => {
            if (interaction.customId === 'cancel-ticket') {
                ...
                interaction
                    .reply({
                        embeds: [new EmbedBuilder().setColor(color).setDescription('Cancelled the ticket deletion.')],
                    })
                    .catch(e => {});
