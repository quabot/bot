import { type Client, ButtonInteraction, ColorResolvable, ActionRowBuilder, ButtonBuilder, ButtonStyle, Colors } from "discord.js";
        ...
        await channel.messages
            ...
            .then(async (message: any) => {
                ...
                await interaction.editReply({
                    embeds: [
                        new Embed(color)
                            .setDescription('Suggestion deleted.')
                    ]
                });

                await Suggest.findOneAndDelete({ id: suggestionId, guildId: interaction.guildId });
