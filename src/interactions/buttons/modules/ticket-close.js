...
module.exports = {
  ...
  async execute(client, interaction, color) {
    ...
    await interaction.channel.permissionOverwrites.edit(ticket.owner, { ViewChannel: true, SendMessages: false });
    ticket.users.forEach(async user => {
      await interaction.channel.permissionOverwrites.edit(user, { ViewChannel: true, SendMessages: false });
    });
