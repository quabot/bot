...
module.exports = {
    ...
    async execute(client, interaction, color) {
        ...
        await interaction.showModal(footerModal).catch(() => null);
        ...
        if (modal) {
            ...
            if (!text) return modal.editReply({ embeds: [await generateEmbed(color, "No text entered, try again.")], ephemeral: true }).catch(() => null);
