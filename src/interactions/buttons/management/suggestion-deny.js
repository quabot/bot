        ...
        const msg = await channel.messages
            ...
            .then(async message => {
                ...
                if (modal) {
                    ...
                    modal
                        .editReply({
                            embeds: [await generateEmbed(color, 'Denied the suggestion.')],
                            ephemeral: true,
                        })
                        .catch(e => {});
                        ...
                        member
                            .send({
                                embeds: [
                                    await generateEmbed(
                                        color,
                                        `Your suggestion in ${interaction.guild.name} was denied. Go check it out [here](${message.url})!`
