...
export default class DiscordServices extends Service {
     ...
     */
    postNews(id: IDResolvable, title: string, content: string): Promise<import("axios").AxiosResponse<never>>;
    /**
     * Posts commands info to your bot page
     * @param id The bot's ID
     * @param commands The command info to post
     */
    postCommands(id: IDResolvable, commands: DiscordServicesCommandInfo[]): Promise<import("axios").AxiosResponse<never>>;
}
