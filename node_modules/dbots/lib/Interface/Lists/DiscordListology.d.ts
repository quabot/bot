...
export default class DiscordListology extends Service {
     ...
     */
    getBotStats(id: IDResolvable): Promise<import("axios").AxiosResponse<never>>;
    /**
     * Checks whether or not a user has voted for a bot on this service.
     * @param id The bot's ID
     * @param userID The user's ID
     */
    userVotedBot(id: IDResolvable, userID: IDResolvable): Promise<import("axios").AxiosResponse<never>>;
    /**
     * Gets the guild's stats listed on this service.
     * @param id The guild's ID
     */
    getGuildStats(id: IDResolvable): Promise<import("axios").AxiosResponse<never>>;
    /**
     * Checks whether or not a user has voted for a guild on this service.
     * @param id The guild's ID
     * @param userID The user's ID
     */
    userVotedGuild(id: IDResolvable, userID: IDResolvable): Promise<import("axios").AxiosResponse<never>>;
}
