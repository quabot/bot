...
export default class YABL extends Service {
    ...
    invalidate(): Promise<import("axios").AxiosResponse<never>>;
    /**
    ...
    getRandomBots(): Promise<import("axios").AxiosResponse<never>>;
    /**
    ...
    getBots(): Promise<import("axios").AxiosResponse<never>>;
    /**
     * Gets a page of bots on this service.
     * @param query The query string that will be used in the request
     */
    getBotsByPage(query: Query): Promise<import("axios").AxiosResponse<never>>;
    /** Gets a list of unverified bots on this service. */
    getUnverifiedBots(): Promise<import("axios").AxiosResponse<never>>;
}
