...
module.exports = {
    ...
    async execute(interaction, client) {
        if (interaction.isSelectMenu()) {
            if (interaction.values[0] === "fun_commands") interaction.reply({ ephemeral: true, embeds: [fun]}).catch(err => console.log("Error!"));
            if (interaction.values[0] === "info_commands") interaction.reply({ ephemeral: true, embeds: [info]}).catch(err => console.log("Error!"));                                                                                                                                                                                                                                                                                                                                                                    
            if (interaction.values[0] === "music_commands") interaction.reply({ ephemeral: true, embeds: [music]}).catch(err => console.log("Error!"));                                                                                                                                                                                                                                                                                                                                                                    
