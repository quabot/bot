        ...
        try {
            ...
            if (interaction.isButton()) {
                if (interaction.customId === "enableLevel") {
                    ...
                    interaction.update({ ephemeral: true, embeds: [levelEnabled], components: [disabled] }).catch(( err => { } ))
                }
                ...
                if (interaction.customId === "disableLevel") {
                    ...
                    interaction.update({ ephemeral: true, embeds: [levelDisabled], components: [disabled] }).catch(( err => { } ))
                }
                ...
                if (interaction.customId === "enableLogs") {
                    ...
                    interaction.update({ ephemeral: true, embeds: [logEnabled], components: [disabled] }).catch(( err => { } ))
                }
                ...
                if (interaction.customId === "disableLogs") {
                    ...
                    interaction.update({ ephemeral: true, embeds: [logDisabled], components: [disabled] }).catch(( err => { } ))
                }

                if (interaction.customId === "enableRole") {
                    if (!interaction.member.permissions.has("ADMINISTRATOR")) return interaction.reply({ ephemeral: true, embeds: [noPermission] }).catch(( err => { } ))
                    interaction.update({ ephemeral: true, embeds: [roleEnabled], components: [disabled] }).catch(( err => { } ))
                    await guildDatabase.updateOne({
                        roleEnabled: true
                    });
                }
                ...
                if (interaction.customId === "disableRole") {
                    if (!interaction.member.permissions.has("ADMINISTRATOR")) return interaction.reply({ ephemeral: true, embeds: [noPermission] }).catch(( err => { } ))
                    interaction.update({ ephemeral: true, embeds: [roleDisabled], components: [disabled] }).catch(( err => { } ))
                    await guildDatabase.updateOne({
                        roleEnabled: false
                    });
                }
