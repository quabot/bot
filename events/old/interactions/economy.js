            ...
            if (interaction.isButton()) {
                ...
                const UserEcoDatabase = await UserEco.findOne({
                    ...
                    if (!usereco) {
                        ...
                        return interaction.channel.send({ embeds: [addedEmbed] }).catch(( err => { } ))
                    }
                }).clone().catch(function (err) { console.log(err) });
                ...
                if (interaction.customId === `lottery-${userId}`) {
                    ...
                    interaction.update({ components: [buttonsLotteryDis] }).catch(( err => { } ))
                    ...
                    if (UserEcoDatabase.lastLottery !== undefined) {
                        ...
                        if (difference < 1800) {
                            ...
                            interaction.channel.send({ embeds: [notValid] }).catch(( err => { } ))
                            return;
                        }
                    }
                ...
                if (interaction.customId === `murder-${userId}`) {
                    interaction.update({ components: [buttonsCrimeDis] }).catch(( err => { } ))
