        ...
        try {
            ...
            if (args[0] === "max" || args[0] === "all") {
                ...
                const embed = new discord.MessageEmbed()
                    .setTitle(`Withdrew ⑩ ${amount.toLocaleString('en-US', {minimumFractionDigits: 0})}`)
                    .setDescription(`There's now **⑩ 0** in your wallet and **⑩ ${a.toLocaleString('en-US', {minimumFractionDigits: 0})}** in your pocket.`)
