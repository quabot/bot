...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        try {
            ...
            if (!song) return interaction.reply({ embeds: [noSongs] }).catch(err => console.log(err));
            ...
            interaction.reply({ embeds: [playingEmbed], components: [skipButtons] }).catch(err => console.log(err));
        } catch (e) {
            interaction.channel.send({ embeds: [error] }).catch(err => console.log(err));
