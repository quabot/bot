...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        try {
            ...
            if (!song) return interaction.reply({ embeds: [noSongs] }).catch(err => console.log("Error!"));
            ...
            interaction.reply({ embeds: [playingEmbed], components: [skipButtons] }).catch(err => console.log("Error!"));
        } catch (e) {
            interaction.channel.send({ embeds: [error] }).catch(err => console.log("Error!"));
