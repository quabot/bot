...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        try {
           ...
           if (discriminator.length !== 4) return interaction.reply({ ephemeral: true, embeds: [replyInv] }).catch(err => console.log("Error!"));
           if (isNaN(discriminator)) return interaction.reply({ ephemeral: true, embeds: [replyInv] }).catch(err => console.log("Error!"));
            ...
            if (matches.length === 0) {
                ...
                return interaction.reply({ ephemeral: true, embeds: [replyelse] }).catch(err => console.log("Error!"));
            }
