...
module.exports = {
    ...
    async execute(client, interaction) {
        try {
            ...
            if (guildDatabase.reportEnabled === "false") return interaction.reply({ embeds: [reportDis] }).catch(err => console.log("Error!"));

            const reportsChannel = interaction.guild.channels.cache.get(guildDatabase.reportChannelID);
            if (!reportsChannel) return interaction.reply({ embeds: [reportNoChannel] }).catch(err => console.log("Error!"));

            const content = interaction.options.getString('report');
            if (!content) return interaction.reply({ embeds: [reportNoReport] }).catch(err => console.log("Error!"));
            ...
            interaction.reply({ ephemeral: true, embeds: [reportSucces] }).catch(err => console.log("Error!"));
            ...
            reportsChannel.send({ embeds: [embed] }).catch(err => console.log("Error!"));
